...
const fillColor = ref('var(--grey-300)')

watch(() => state, (newState) => {
  switch (newState) {
    case IconState.Hovered: {
      fillColor.value = 'var(--grey-100)';
      break;
    }
